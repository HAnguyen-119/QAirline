    ...
    return (
        <div className='about'>
            ...
            <div className="basic-info-container">
                <BasicInfo icon={faCalendarDays} number="2024" info="Founded" />
                <BasicInfo icon={faPlaneDeparture} number="#10" info="Best airline in Vietnam" />
                <BasicInfo icon={faEarthAmerica} number="50" info="Branches global" />
                <BasicInfo icon={faPeopleGroup} number="10000+" info="Employees" />
            </div>

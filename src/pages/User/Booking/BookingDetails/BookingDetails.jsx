...
import {sendCancelNotification, sendOTP} from "../../../../utils/SendEmail.js";
        ...
        if (otpUserInput === randomOTP) {
            try {
                const deleteBooking = async () => {
                    ...
                    sendCancelNotification(booking.email, state.lastName, booking.code);
                    navigate('/booking');
                }
                deleteBooking()
            } catch (error) {
        ...
        <div className='booking-details-container'>
            ...
            <div className='booking-details-form'>
                <div className='booking-details'>
                    ...
                    <p>Your Booking code is: {params.get('booking-code')}</p>
